...
def create_table():
    c.execute('CREATE TABLE IF NOT EXISTS tbl_fileCheck(lastChecked TEXT, srcFolder TEXT, destFolder TEXT, movedTF INTEGER)')
create_table()
...
def make_transfer(self):
    ...
    if messagebox.askokcancel("Confirm File Transfer", "Check for files to transfer from: \n\n{} \nto \n{}?".format(srcVar, destVar)):
